          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                  ...
                  <a class="dropdown-item" href="../therapy/otherservice.html">Other Therapy Services</a>
                  <a class="dropdown-item" href="../therapy/clinic.html">High Hopes Clinic</a>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <div class="card card-inverse">
          <img class="card-img img-fluid w-100" src="../preschool/capture/download.jpeg" alt="">
          <div class="card-img-overlay bg-overlay">
            <h4 style="text-align: left; color: white;">Your contact submission has been sent! Thank you for contacting High Hopes.</h4>
            <a href="contact.html" class="btn btn-warning">Return</a>
          </div>
        </div>
      </div>
